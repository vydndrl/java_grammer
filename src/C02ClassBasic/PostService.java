...
class Author {
    ...
    public static void register(Scanner scan) {
        ...
        Author author = new Author(name, email, passwd);
        authors.put(static_id, author);
    ...
    public static void detailAuthor(Scanner scan) {
        ...
        if(author != null){
            ...
            System.out.println("작성글수: " + author.getPosts().size());
